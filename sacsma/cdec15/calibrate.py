...
The 15-CDEC calibration setup: a pooled-KGE GA across the 15 basins against
the daily observed gage FNF (``load_gage``), with defaults matching the
archived Wi & Steinschneider run.  **Not wired to the forward model yet** —
this is a reusable bounded real-coded GA engine plus a KGE objective helper.
