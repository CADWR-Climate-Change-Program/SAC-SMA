...
The statics stores cover only the 2480 modeling-domain cells. The 1930 footprint-only cells need a raster ingest (POLARIS / LANDFIRE / 3DEP / MODIS-LAI from `data/raw_gis/`, see [`../data/raw_gis/SOURCES.md`](../data/raw_gis/SOURCES.md)), gated on reproducing the committed point-sample rows, before any full-region training.
